  ...
  head: () => ({
    meta: [
      ...
      { title: "AURELLE — Luxury Shopping, Curated Worldwide" },
      {
        name: "description",
        content:
          "AURELLE curates luxury fashion, electronics, beauty, home and lifestyle from the world's finest makers.",
      },
      { name: "author", content: "AURELLE" },
      { property: "og:title", content: "AURELLE — Luxury Shopping, Curated Worldwide" },
      {
        property: "og:description",
        content: "Discover extraordinary. Premium products, curated and shipped worldwide.",
      },
